    ...
    <div className={s.page}>
      ...
      <header className={s.nav}>
        <div className={`${s.container} ${s.navInner}`}>
          <Link href="/intro" className={s.wordmark}>GGya</Link>
          ...
          <div className={s.navRight}>
            <Link href="/" className={`${s.pill} ${s.pillLight} ${s.navPill}`}>경매 입장</Link>
          </div>
        </div>
      </header>
      ...
      <section className={s.hero}>
        <div className={`${s.container} ${s.heroInner}`}>
          ...
          <div className={s.heroActions}>
            <Link href="/" className={`${s.pill} ${s.pillDark}`}>경매 입장</Link>
        ...
        <div className={`${s.container} ${s.footerInner}`}>
          <div className={s.footerCols}>
            ...
            <div>
              ...
              <ul className={s.footerList}>
                <li><Link className={s.footerLink} href="/">경매 입장</Link></li>
